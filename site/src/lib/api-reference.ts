  ...
  pptx: [
    ...
    },
    {
      ...
      options: [
        ...
        { name: 'showComments', type: 'boolean', def: 'false', desc: 'Show the read-only slide comment markers and the plain built-in margin cards.' },
        { name: 'commentUi', type: 'PptxCommentUiOptions', def: 'undefined', desc: 'Replace comment card contents through the shared synchronous mount/update/destroy lifecycle, include resolved threads, or mount optional slide-to-margin decoration. The Viewer retains placement, activation, virtualization, and cleanup.' },
  ...
  docx: [
    ...
    },
    {
      ...
      options: [
        ...
        { name: 'showComments', type: 'boolean', def: 'false', desc: 'Show the read-only document comment highlights and the plain built-in margin cards.' },
        { name: 'commentUi', type: 'DocxCommentUiOptions', def: 'undefined', desc: 'Replace comment card contents through the shared synchronous mount/update/destroy lifecycle, include resolved threads, or mount optional page-to-margin decoration. The Viewer retains placement, activation, virtualization, and cleanup.' },
  ...
  xlsx: [
    {
      ...
      options: [
        ...
        { name: 'showComments', type: 'boolean', def: 'true', desc: 'Show authored cell note or threaded-comment markers and their anchored read-only popup.' },
        { name: 'commentUi', type: 'XlsxCommentUiOptions', def: 'undefined', desc: 'Replace the cell-anchored popup contents through the shared synchronous mount/update/destroy lifecycle or include resolved threads. The Viewer retains cell anchoring, hover/touch visibility, sheet navigation, and cleanup.' },
        FIND_HIGHLIGHT_COLORS,
    ...
    },
    {
      ...
      options: [
        ...
        { name: 'showComments', type: 'boolean', def: 'true', desc: 'Show authored cell note or threaded-comment markers and their anchored read-only popup.' },
        { name: 'commentUi', type: 'XlsxCommentUiOptions', def: 'undefined', desc: 'Replace the cell-anchored popup contents through the shared synchronous mount/update/destroy lifecycle or include resolved threads. The Viewer retains cell anchoring, hover/touch visibility, viewport movement, and cleanup.' },
        FIND_HIGHLIGHT_COLORS,
