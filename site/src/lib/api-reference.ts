  ...
  docx: [
    {
      ...
      methods: [
        ...
        { sig: 'whenLayoutComplete(): Promise<void>', desc: 'Wait for the authoritative full layout before operations that require the final page count. Rejects if background pagination fails after load() resolved.' },
        { sig: 'get canvasElement(): HTMLCanvasElement', desc: 'The underlying canvas.' },
    ...
    },
    {
      ...
      methods: [
        ...
        { sig: 'get layoutComplete(): boolean', desc: 'True when pageCount and the document layout are authoritative; false while progressive layout is still publishing pages.' },
        { sig: 'whenLayoutComplete(): Promise<void>', desc: 'Wait for the authoritative full layout. Rejects if background pagination fails after load() resolved.' },
