  ...
  pptx: [
    ...
    },
    {
      ...
      options: [
        ...
        { name: 'commentUi', type: 'PptxCommentUiOptions', def: 'undefined', desc: 'Control resolved-thread visibility for the built-in comment UI. Theme cards, markers, and connectors with the documented CSS custom properties on the Viewer container.' },
  ...
  docx: [
    ...
    },
    {
      ...
      options: [
        ...
        { name: 'commentUi', type: 'DocxCommentUiOptions', def: 'undefined', desc: 'Control resolved-thread visibility for the built-in comment UI. Theme cards, highlights, and connectors with the documented CSS custom properties on the Viewer container.' },
  ...
  xlsx: [
    {
      ...
      options: [
        ...
        { name: 'commentUi', type: 'XlsxCommentUiOptions', def: 'undefined', desc: 'Control resolved-thread visibility for the built-in cell popup. Theme the popup with the documented CSS custom properties on the Viewer container.' },
        FIND_HIGHLIGHT_COLORS,
