...
| S-STYLE-002 | `chartArea`, `plotArea`, `legend` | Partial | Chart-area and legend linked structured fills honor direct paint and `noFill` precedence in shared 2-D/3-D paths; legend outlines are also consumed. Plot-area linked fills are consumed by Cartesian, stock, scatter/bubble, histogram, and Pareto paths. Chart-area/plot-area outlines and the remaining plot-area chart families are incomplete. |
