...
| C-STOCK-001 | Stock drop lines, high-low lines, and up/down bars | Yes | Yes | Yes | Partial | Stock drop/high-low lines preserve direct and linked line paint, including `noFill`, width, and preset dash. Up/down bars preserve solid fill plus outline visibility, color, width, preset dash, cap, and join; structured bar fills remain incomplete. |
